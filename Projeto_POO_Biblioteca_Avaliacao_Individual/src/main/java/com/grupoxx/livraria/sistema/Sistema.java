...
public class Sistema {
    ...
    public Sistema() throws EstanteNaoEncontrada, IOException, ClassNotFoundException{
    ...
    public static boolean cadastraUsuario(String nome, String senha) throws UsuarioCriacaoException, IOException{
    ...
    public static void sairConta() throws SalvarStatusException, IOException{
    ...
    ////////////BIBLIOTECA
    public static void adicionarLivro() throws SalvarStatusException, IOException{
        if(estante == null)
            estante = new Estante();
    ...
    public static void removerLivro() throws SalvarStatusException, IOException{
        if(estante.quantidadeDeLivros() != 0){
    ...
    public static void adicionarLivroIG(String nomeL, String categoria, String autor, int anoPub, int numPag, String sinopse) throws SalvarStatusException, IOException{ //Função para Interface grafica
    ...
    public static void removerLivroIG (int i) throws SalvarStatusException, IOException{ //Função para Interface grafica
        estante.removerLivroIG(i);
        SalvarStatus.salvarStatus(estante, "Estante.arq");
    }
     
    /////////USUARIO
    public static Livro infoLivro(int i) throws SalvarStatusException, IOException{
        ArrayList<Livro> livros = user.getLivrosAlugados();
        Livro l = livros.get(i);
        return l;
    }
    
    public static void alugarLivro() throws SalvarStatusException, IOException{
    ...
    public static void devolverLivro() throws SalvarStatusException, IOException{
        if(user.getNumLivrosAlugados() != 0){
            user.listarLivros();
    ...
    public static void devolverLivroIG(int i) throws SalvarStatusException, IOException{ //Função para Interface grafica
        estante.adicionarLivroAlugado(user.devolverLivro(i));
        SalvarStatus.salvarStatus(estante, "Estante.arq");
        SalvarStatus.salvarStatus(user, user.getName()+user.getSenha());
    }
    
    public static void alugarLivroIG(int i) throws SalvarStatusException, IOException{ //Função para Interface grafica
